...
// - pay to sign register (no password) $4.99
// - easy search curated simple GF and vegan recipes
// - checkbox as you cook
...
export const Features: FC<FeaturesProps> = () => {
  ...
  return (
    <div className="bg-dino-red-500 pt-7 pb-10 md:rounded-lg lg:rounded-br-3xl">
